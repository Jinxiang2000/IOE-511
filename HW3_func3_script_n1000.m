%% Script to run HW3 function3 (n = 1000)
close all
clear all
clc
...
% x^* = [-1.2448; 1.0000, ...., 1.0000]; f^* = -0.2056;
...
[x,f] = optSolver_Shao_Yubo(problem,method,options);
% x^* = [-1.2448; 0.9923, ...., 0.9923]; f^* = -0.2056;
...
[x,f] = optSolver_Shao_Yubo(problem,method,options);
% x^* = [-1.2448; 0.9999, ...., 0.9999]; f^* = -0.2056;
...
[x,f] = optSolver_Shao_Yubo(problem,method,options);
% x^* = [-1.2448; 1.0001, ...., 1.0001]; f^* = -0.2056;
